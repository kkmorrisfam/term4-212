...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: Expected Bob, Actual: Sue; It's coming out in the wrong order.  The last name (Sue) comes out first, not Bob.
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: Expected Bob, Actual: Sue; Tim does not get forever turns
    ...
    // Defect(s) Found: Expected Tim; Actual Sue; Tim comes out of queue
